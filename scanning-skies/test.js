...
describe('scanningSkies', () => {
  test('returns correct result', () => {
    ...
    expect(scanningSkies(destinations)).toEqual(['CDG', 'HKG', 'LHR', 'PVG', 'HND', 'ORD', 'AMS', 'DFW']);
    ...
    expect(scanningSkies(destinations)).toEqual(['DEN', 'JFK', 'CAN', 'IST', 'FRA', 'ICN', 'BKK', 'CGK', 'DEL', 'SFO', 'KUL', 'MAD', 'LAS', 'SIN']);
  });
});